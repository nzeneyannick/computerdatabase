...
//public class AddComputerremove extends HttpServlet {
//	private static final Logger LOG = (Logger) LoggerFactory.getLogger(AddComputerremove.class);
//
//	@Autowired
...
//		} catch (Exception e) {
//			LOG.error("Error checkNameCompany", e);
...
//			} catch (Exception e) {
//				LOG.error("Error isValidRangeDate", e);
//			}
//
